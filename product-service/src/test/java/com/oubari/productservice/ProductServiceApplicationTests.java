package com.oubari.productservice;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.oubari.productservice.dto.ProductRequest;
import com.oubari.productservice.repository.ProductRepository;
...
class ProductServiceApplicationTests {
	...
	public static  void getProperties(DynamicPropertyRegistry dynamicPropertyRegistry ){
	...
	private ProductRequest getProductRequest(){
		return ProductRequest.builder().name("pc gamer ").description("dell xps 13").price(BigDecimal.valueOf(312)).build();
	}
